...
export default function Calendars({ step }) {
  const { slideOver } = useContext(uicontext) ; 
  return (
    <>
      <div>
        <div className='relative mt-4'>
          <h2 className="text-3xl capitalize font-bold tracking-tight text-center text-gray-900">vui lòng đặt lịch hẹn bảo dưỡng</h2>
          {step && <button className="rounded-lg text-lg tracking-tight capitalize text-white font-medium mt-2 sm:mt-4 bg-c-blue-1 py-1 px-2 ml-auto block hover:opacity-70">Bước tiếp</button>}
        </div>
